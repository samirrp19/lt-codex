...
import TabsComponent from './components/TabsComponent'; // Tabs for different post types
import PostContentSection from './components/PostContentSection'; // Content display based on tabs
import PostInputForm from './components/PostInputForm'; // The input form with icons for Program, Project, Template, etc.
