...
const MenuSection = () => {
  ...
  const menuItems = [
    ...
    { icon: "/icons/pages/question.png", text: "Hackathons", route: `/${username}/hackathons` },
    { icon: "/icons/pages/competing.png", text: "Challenges", route: `/${username}/challenges` },
    { icon: "/icons/pages/programming.png", text: "Practice", route: `/${username}/practice` },
    { icon: "/icons/pages/robot.png", text: "AI Chat", route: `/community/chat` },
  ];
